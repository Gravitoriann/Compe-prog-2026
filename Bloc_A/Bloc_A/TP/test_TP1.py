...
from TP.TP1 import solve


def test_from_problem_description():
    assert solve("C wc xeyaalftspryao shessrpie  s rnraaitogsl cec") == "Cyphers are always a classic for text processing"
    assert solve("Blssrreatya g pvmedtoe éé sec!") == "Bravo le message est décrypté!"
    assert solve("A pgaha eicrny!") == "Again a cypher!"
